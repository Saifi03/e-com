                ...
                <div class="bg-light rounded p-4">
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('AdminCon/submitProduct'); ?>">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="product_mrp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="product_per_price" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    <?php echo form_error('product_per_price'); ?>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Product Quantity</label>
                                    <input type="text" name="product_qty" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    <?php echo form_error('product_qty'); ?>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Product Per Quantity</label>
                                    <input type="text" name="product_per_qty" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea rows="4" cols="100" class="form-control" name="product_description"></textarea>
                                    <?php echo form_error('product_description'); ?>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Product Sm Description</label>
                                    <input type="text" name="product_sm_desc" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    <?php echo form_error('product_sm_desc'); ?>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Product Meta Title</label>
                                    <input type="text" name="product_meta_title" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    <?php echo form_error('product_meta_title'); ?>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Product Meta Keyword</label>
                                    <input type="text" name="product_meta_keyword" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                    <?php echo form_error('product_meta_keyword'); ?>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Product Meta Description</label>
                                    <input type="text" name="product_meta_desc" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
