...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="container-fluid">
            ...
            <form method="post" action="<?php echo base_url('AdminCon/AdminLogin'); ?>">
                    ...
                    <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                        <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                            ...
                            <div class="form-floating mb-3">
                                <input type="email" name="email_id" class="form-control" id="floatingInput" placeholder="name@example.com">
                            ...
                            <a href="<?php echo base_url('AdminCon/forgetPassword'); ?>">Forgot Your Password?</a>
                            </div>
